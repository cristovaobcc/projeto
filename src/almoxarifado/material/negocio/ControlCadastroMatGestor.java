...
public final class ControlCadastroMatGestor {
	...
	/**
	 * Insere um material m não-null passado no repositório caso o material não exista no
	 * Repositório e se m respeitar os critérios:
	...
	/**
	 * Imprime a msg de erro passada no parâmetro.
	 * @param msg String
	 */
